...
<div class="logo_fabricante" align="center"><?php print (file_exists(PATH_IMG_FABRICANTE_SITE.$fab->idFabricante.".".$fab->extImg1) ? "<img src='".PATH_IMG_FABRICANTE_SITE.$fab->idFabricante.".".$fab->extImg1."' border='1'  width='200' height='104' />" : "") ?></div>
