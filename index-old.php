...
switch($_REQUEST['land'])
{
	...
	case "treinamentos_det":
		$page = "pages/fabricante_det.php";
		$breadcrumb = '<li><a href="index.php?land=treinamentos'.($_GET['p'] ? "&p=".$_GET['p'] : "").'">Voltar para Treinamentos</a></li>';
	break;
	case "perfil_empresa":
	...
	*/
	...
	default:
		...
		{
			$page = "pages/fabricantes.php";
			$breadcrumb = '<li><a href="index.php?land=treinamentos&begin=1"></a></li>';
		}
		else
		{
			$page = "pages/login.php";
        ...
        <div class="header">
            ...
            <div class="menu">
                ...
                <div class="texto_menu"><ul>
                    ...
                    <li><a href="index.php?land=treinamentos&begin=1">Treinamentos</a></li>
