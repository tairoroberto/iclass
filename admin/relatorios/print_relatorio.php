...
<div>
<span style="font-weight: bold; font-size: 16px; color: #006;">RELAT&Oacute;RIO DOS USUÁRIOS DO SITE</span><br /><br />
...
<table align="center" cellpadding="1" cellspacing="0" style="width: 100%; border-collapse: collapse; color: #333333; font-family:Arial, Helvetica, sans-serif;"  border="1" bordercolor="#999999" >
    <tr>
        ...
        <td style="color: #006; font-weight: bold; text-align: left;	padding: 2px; width: 20%;">Treinamento</td>
        <td style="color: #006; font-weight: bold; text-align: left;	padding: 2px; width: 10%;">Média do Quiz (0 a 10)</td>
    </tr>
    <!-- registros -->
    <? print $usuario_site->printRelatorio(); ?>
</table>
</body>
</html>
