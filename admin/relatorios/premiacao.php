...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	<tr>
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">R E L A T Ó R I O&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;P R E M I A Ç Ã O</td>
	</tr>
	<tr>
			...
			<table style="width: 100%;" cellpadding="3" cellspacing="0">
				...
				<tr>
					<td style="height: 60px; padding-top: 10px; border: 1px solid #CCCCCC; background-color: #EFEFEF;">
						<form action="print_relatorio_premiacao.php" target="_blank" method="POST">
