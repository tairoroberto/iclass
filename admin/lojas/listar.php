<?
...

	{
		...
		$loja->delLoja( trataVarSql($_GET['idLoja']) );
...

	{
		...
		$_SESSION['fNomeLoja'] 	= $_POST['fNomeLoja'];
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	...
	<tr>
		...
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;L O J A S</td>
						...
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomeLoja" id="fNomeLoja" value="<?=$_SESSION['fNomeLoja']?>" style='width: 200px;' /></td>
