<?
...

	{
		...
		$perfil->delPerfil( trataVarSql($_GET['idPerfil']) );
...

	{
		...
		$_SESSION['fNomePerfil'] 	= $_POST['fNomePerfil'];
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	...
	<tr>
		...
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;P E R F I S</td>
						...
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomePerfil" id="fNomePerfil" value="<?=$_SESSION['fNomePerfil']?>" style='width: 200px;' /></td>
