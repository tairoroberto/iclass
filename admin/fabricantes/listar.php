<?	require_once "../../inc/config.inc.php";
	...
	{
		$fabricante->delFabricante( trataVarSql($_GET['idFabricante']) );
		if( $_GET['p'] )
			$p = "p=".$_GET['p'];
		else
			$p = "begin=1";
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	<tr>
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;F A B R I C A N T E S</td>
	</tr>
	<tr>
					...
					<td style="height: 60px; padding-top: 10px; border: 1px solid #CCCCCC; background-color: #EFEFEF;">
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								<tr>
									<td>Nome: </td>
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomeFabricante" id="fNomeFabricante" value="<?=$_SESSION['fNomeFabricante']?>" style='width: 200px;' /></td>
								</tr>
								<tr>
									<td></td>
				...
				<tr>
					<td style="padding-top: 10px;">
						<table align="center" cellpadding="3" cellspacing="0" style="width: 98%; border-collapse: collapse; color: #666666;" border="1" bordercolor="#999999">
							...
							<!-- registros -->
							<? print $fabricante->listaFabricantes( 10 ); ?>
						</table>
					</td>
				</tr>
			</table>
