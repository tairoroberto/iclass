<?	require_once "../../inc/config.inc.php";
	...
	{
		$premio->delPremio( trataVarSql($_GET['idPremio']) );
		if( $_GET['p'] )
			$p = "p=".$_GET['p'];
		else
			$p = "begin=1";
	...
	{
		$_SESSION['fNomePremio'] 	= $_POST['fNomePremio'];
	}
	
	//esvaziando os filtros se for o primeiro acesso. 
	if( $_GET['begin'] )
	{
		$_SESSION['fNomePremio'] 	= "";
	}
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	<tr>
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;P R &Ecirc; M I O S</td>
	</tr>
	<tr>
					...
					<td style="height: 60px; padding-top: 10px; border: 1px solid #CCCCCC; background-color: #EFEFEF;">
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								<tr>
									<td>Nome: </td>
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomePremio" id="fNomePremio" value="<?=$_SESSION['fNomePremio']?>" style='width: 200px;' /></td>
								</tr>
								<tr>
									<td></td>
