<?
	...
	$allFabricantes = $fabricante->allFabricantesSemPremio($_GET['idPremio']);
		...
		<td style="padding-top: 10px;">
			<form name="form" id="form" action="incluir.php?action=<?=($_GET['action'] ? $_GET['action'] : "incluir")?>" method="POST" onsubmit="return submitForm();" enctype="multipart/form-data">
				...
				<table cellpadding="5" cellspacing="0" border="0" align="center">
                    ...
                    <tr>
						<td style="width: 400px; text-align: center; font-weight: bold; padding-top: 10px;" id="txtNome" colspan="2">Imagens do Pr&ecirc;mio (.gif ou .jpg):</td>
					</tr>
                    <tr>
							...
							<table cellpadding="2" cellspacing="2">
                            	<tr>
                                	<td>
                                        <table cellpadding='3' cellspacing='0' border='1' align="center" style='width: 100px; border-collapse: collapse;' bordercolor="#CCCCCC">
                                            <tr>
                                                <td style='text-align: center; background-color: #EFEFEF;'><?=(file_exists(PATH_IMG_PREMIO .$_GET['idPremio']."_1.".$linhaReg->extImg1)  ? "<input type='button' onclick='delImg(\"".$_GET['idPremio']."\", \"1\")' name='btExcluiImg1'  class='inputButton' value='Excluir Imagem' />" : "")?></td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <div align="center" style='width: 100px; height: 100px; border: 1px solid #CCCCCC;'>
                                                        <img id="imagem1" src="<?=loadImage($_GET['idPremio']."_1.".$linhaReg->extImg1)?>" border='0' style='width: 100px; height: 100px;' />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <!--<td>
                                        <table cellpadding='3' cellspacing='0' border='1' align="center" style='width: 100px; border-collapse: collapse;' bordercolor="#CCCCCC">
                                            <tr>
                                                <td style='text-align: center; background-color: #EFEFEF;'><b>2 </b><?=(file_exists(PATH_IMG_PREMIO .$_GET['idPremio']."_2.".$linhaReg->extImg2) ? "<input type='button' onclick='delImg(\"".$_GET['idPremio']."\", \"2\")' name='btExcluiImg2' class='inputButton' value='Excluir Imagem' />" : "")?></td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <div align="center" style='width: 100px; height: 100px; border: 1px solid #CCCCCC;'>
                                                        <img id="imagem2" src="<?=loadImage($_GET['idPremio']."_2.".$linhaReg->extImg2)?>" border='0' style='width: 100px; height: 100px;' />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
								...
								<!--<tr>
                                	<td>
                                        <table cellpadding='3' cellspacing='0' border='1' align="center" style='width: 100px; border-collapse: collapse;' bordercolor="#CCCCCC">
                                            <tr>
                                                <td style='text-align: center; background-color: #EFEFEF;'><b>3 </b> <?=(file_exists(PATH_IMG_PREMIO .$_GET['idPremio']."_3.".$linhaReg->extImg3)  ? "<input type='button' onclick='delImg(\"".$_GET['idPremio']."\", \"3\")' name='btExcluiImg3'  class='inputButton' value='Excluir Imagem' />" : "")?></td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <div align="center" style='width: 100px; height: 100px; border: 1px solid #CCCCCC;'>
                                                        <img id="imagem1" src="<?=loadImage($_GET['idPremio']."_3.".$linhaReg->extImg3)?>" border='0' style='width: 100px; height: 100px;' />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td>
                                        <table cellpadding='3' cellspacing='0' border='1' align="center" style='width: 100px; border-collapse: collapse;' bordercolor="#CCCCCC">
                                            <tr>
                                                <td style='text-align: center; background-color: #EFEFEF;'><b>4 </b><?=(file_exists(PATH_IMG_PREMIO .$_GET['idPremio']."_4.".$linhaReg->extImg4) ? "<input type='button' onclick='delImg(\"".$_GET['idPremio']."\", \"4\")' name='btExcluiImg4' class='inputButton' value='Excluir Imagem' />" : "")?></td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <div align="center" style='width: 100px; height: 100px; border: 1px solid #CCCCCC;'>
                                                        <img id="imagem2" src="<?=loadImage($_GET['idPremio']."_4.".$linhaReg->extImg4)?>" border='0' style='width: 100px; height: 100px;' />
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
