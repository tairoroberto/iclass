		...
		<li><a href="#">Redes</a>
			<ul>
				...
				<li><a href="#">Fabricantes</a>
					<ul>
						<li><a href="javascript:redirectPage('fabricantes/incluir.php');">Incluir Fabricante</a></li>
						<li><a href="javascript:redirectPage('fabricantes/listar.php?begin=1');">Listar Fabricantes</a></li>
					</ul>
				</li>
			</ul>
		</li>
