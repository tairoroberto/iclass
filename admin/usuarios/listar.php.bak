<?
...

	{
		...
		$usuario->delUsuario( trataVarSql($_GET['idUsuario']) );
...

	{
		...
		$_SESSION['fNomeUsuario'] 	= $_POST['fNomeUsuario'];

		$_SESSION['fLogin'] 		= $_POST['fLogin'];
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	...
	<tr>
		...
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;U S U &Aacute; R I O S</td>
						...
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomeUsuario" id="fNomeUsuario" value="<?=$_SESSION['fNomeUsuario']?>" style='width: 200px;' /></td>
								...
								<tr>
									...
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fLogin" id="fLogin" value="<?=$_SESSION['fLogin']?>" style='width: 200px;' /></td>
					...
					<td style="padding-top: 10px;">
						...
						<table align="center" cellpadding="3" cellspacing="0" style="width: 98%; border-collapse: collapse; color: #666666;" border="1" bordercolor="#999999">
							...
							<tr>
								...
								<td class="topTextTitleGrid" style="width: 20%;">Nome</td>

								<td class="topTextTitleGrid" style="width: 20%;">Login</td>

                                <td class="topTextTitleGrid" style="width: 20%;">Date de Registro</td>
							...
							<? print $usuario->listaUsuarios( 10 ); ?>
