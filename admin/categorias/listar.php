<?
...

	{
		...
		$categoria->delCategoria( trataVarSql($_GET['idCategoria']) );
...

	{
		...
		$_SESSION['fNomeCategoria'] 	= $_POST['fNomeCategoria'];
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 90%;" align="center">
	...
	<tr>
		...
		<td style="border-bottom: 1px solid  #CCCCCC; text-align: center; padding-top: 5px; padding-bottom: 5px; color: #FFFFFF; font-weight: bold; background-color: <?=TITULO_INTERNAS_BGCOLOR?>;">L I S T A G E M&nbsp;&nbsp;&nbsp;D E&nbsp;&nbsp;&nbsp;R E D E S</td>
						...
						<form action="listar.php?action=listar" method="POST">
							...
							<table border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td style='padding-left: 10px;'><input type="text" class="inputText" name="fNomeCategoria" id="fNomeCategoria" value="<?=$_SESSION['fNomeCategoria']?>" style='width: 200px;' /></td>
				...
				<tr>
					...
					<td style="padding-top: 10px;">
						...
						<table align="center" cellpadding="3" cellspacing="0" style="width: 98%; border-collapse: collapse; color: #666666;" border="1" bordercolor="#999999">
							...
							<? print $categoria->listaCategorias( 10 ); ?>
